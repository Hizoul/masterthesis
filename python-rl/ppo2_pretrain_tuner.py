...
def optimize_agent(trial):
    ...
    model = model.load("models/pretrain/250000_heutistic_pretrain_box.pkl", env=env, **model_params)
    print("DOING LEARING pretrain_ppo2")
    original_env.force_progression = False
    model.learn(int(2e4*5), seed=seed)
    print("DONE LEARING pretrain_ppo2")
...
if __name__ == '__main__':
    study = optuna.create_study(study_name='ppo2_pretrain', storage='sqlite:///ppo2_pretrain.db', load_if_exists=True,direction="maximize")
